...
Die nachfolgenden Aufgaben basieren auf der veröffentlichten
Jahresrechnung 2024 der Pilatus-Bahnen AG 
([Geschäftsbericht
2024](https://cdn.pilatus.ch/content-media/documents/Unternehmen/Gesch%C3%A4ftsbericht-2024.pdf)).
Die relevanten Ausgangsdaten sind in den Tabellen unten zusammengestellt.
Berechnen Sie alle Kennzahlen auf **zwei Dezimalstellen** (sofern nicht
anders angegeben) und runden Sie kaufmännisch. 
...
| Kennzahl | Formel |
|---|---|
| Liquiditätsgrad 1 | $\frac{\text{Flüssige Mittel}}{\text{Kurzfristiges
FK}} \times 100$ |
| Liquiditätsgrad 2 | $\frac{\text{Flüssige Mittel} + \text{Kurzfr.
Wertschriften} + \text{Ford. L+L}}{\text{Kurzfr. FK}} \times 100$ |
...
| Anlagendeckungsgrad II | $\frac{\text{Eigenkapital} + \text{Langfr.
FK}}{\text{Anlagevermögen}} \times 100$ |
